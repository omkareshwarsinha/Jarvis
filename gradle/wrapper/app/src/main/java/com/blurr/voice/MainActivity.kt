...
class MainActivity : BaseNavigationActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        profileManager.isProfileComplete() // ensures default profile is initialized
        ...
        handleIntent(intent)
        // Welcome greeting
        val ttsManager = TTSManager.getInstance(this.applicationContext)
        lifecycleScope.launch(Dispatchers.IO) {
            ttsManager.speakToUser("Welcome back to Jarvis!")
        }
    ...
    private fun requestLimitIncrease() {
        val userEmail = UserProfileManager(this).getEmail() ?: "jarvis@free-assistant.ai"
    ...
    private fun setupProBanner() {
        ...
        if (proBanner != null) {
            ...
            val upgradeBtn = proBanner.findViewById<View>(R.id.upgrade_button)
