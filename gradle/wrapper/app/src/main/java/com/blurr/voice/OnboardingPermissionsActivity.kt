...
class OnboardingPermissionsActivity : AppCompatActivity() {
    ...
    private fun setupPermissionSteps() {
        ...
        // Standard Permission: SEND_SMS
        permissionSteps.add(
            PermissionStep(
                titleRes = R.string.sms_permission_title,
                descRes = R.string.sms_permission_desc,
                iconRes = R.drawable.bell,
                isGranted = {
                    ContextCompat.checkSelfPermission(
                        this,
        ...
        // Standard Permission: READ_CONTACTS
        permissionSteps.add(
            PermissionStep(
                titleRes = R.string.contacts_permission_title,
                descRes = R.string.contacts_permission_desc,
                iconRes = R.drawable.display,
                isGranted = {
                    ContextCompat.checkSelfPermission(
                        this,
